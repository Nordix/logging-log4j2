...
| xref:manual/rolling-file.adoc#CustomDeleteOnRollover[All `Delete` actions]
| `basePath`
| Rollover
| xref:manual/lookups.adoc#global-context[_global_]
...
https://en.wikipedia.org/wiki/Page_cache[page cache] (file cache), meaning that no copies need to be created in user space.
...
|[[PropertiesRewritePolicy-element-properties]]properties
|Property[]
